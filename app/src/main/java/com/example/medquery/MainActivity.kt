        ...
        setContent {
            Box( contentAlignment = Alignment.Center, modifier = Modifier.fillMaxSize() ) {
                Column(horizontalAlignment = Alignment.CenterHorizontally) {
                    ...
                    Icon(
                        painter = painterResource(id = R.drawable.plus), // Replace 'your_image_file' with your image file's resource identifier
                        contentDescription = "Icon Description" // Provide a description for accessibility
                    )

                    Spacer(modifier = Modifier.height(16.dp)) // Add space between the icon and the button
